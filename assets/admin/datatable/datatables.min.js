 ...
 *   https://datatables.net/download/#dt/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/date-1.5.4/fh-4.0.1/r-3.0.3/sc-2.4.3/sb-1.8.1/sp-2.3.3
 *
 * Included libraries:
 *   DataTables 2.1.8, Buttons 3.2.0, Column visibility 3.2.0, DateTime 1.5.4, FixedHeader 4.0.1, Responsive 3.0.3, Scroller 2.4.3, SearchBuilder 1.8.1, SearchPanes 2.3.3
 */
              ...
              if ('table' != this.nodeName.toLowerCase())
                ...
                var F,
                  ...
                  N =
                    ...
                    c.oFeatures);
                if (
                  (t.bStateSave && (N.bStateSave = !0), void 0 === t.aaSorting)
                )
      ...
      ((V.ext = C =
        {
          ...
          classes: {},
          builder:
            'dt/dt-2.1.8/b-3.2.0/b-colvis-3.2.0/date-1.5.4/fh-4.0.1/r-3.0.3/sc-2.4.3/sb-1.8.1/sp-2.3.3',
          errMode: 'alert',
          feature: [],
          features: {},
          search: [],
      ...
      _clone: function (t, e) {
        ...
        ('footer' === t && this._scrollEnabled()) ||
          (!e && n.floating
            ...
            : (n.floating &&
                (null !== n.placeholder && n.placeholder.remove(),
...
!(function (e) {
  ...
  function B(t, s, e, a, i) {
    ...
    if (l.select)
      return (
        ...
        (this.c = C.extend(!0, {}, B.defaults, s, i)),
        s &&
          s.hideCount &&
          void 0 === s.viewCount &&
        ...
        (this.dom = {
          buttonGroup: C('<div/>').addClass(this.classes.buttonGroup),
          clear: C('<button type="button">&#215;</button>')
            .attr('disabled', 'true')
          ...
          nameButton: C('<button type="button"><span></span></button>')
            .addClass(this.classes.paneButton)
          ...
          searchButton: C('<button type="button"><span></span></button>')
            ...
            .addClass(this.classes.paneButton),
          searchCont: C('<div/>').addClass(this.classes.searchCont),
          searchLabelCont: C('<div/>').addClass(this.classes.searchLabelCont),
          topRow: C('<div/>').addClass(this.classes.topRow),
          upper: C('<div/>')
        ...
        (s = ''),
        this.s.colExists
          ? ((s = C(this.s.dt.column(this.s.index).header()).text()),
        ...
        C.fn.dataTable.ext.search.push(this.s.searchFunction),
        this.c.clear &&
  ...
  function k(t, s, e, a) {
    ...
    if (
      (void 0 === e && (e = !1),
      void 0 === a && (a = h),
      !_ || !_.versionCheck || !_.versionCheck('1.10.0'))
    )
      throw new Error('SearchPane requires DataTables 1.10 or newer');
    if (!_.select) throw new Error('SearchPane requires Select');
    var d,
      i = new _.Api(t);
    if (
  ...
  return (
    ...
    (B.prototype.adjustTopRow = function () {
      ...
      (C(t[0]).width() < 252 || C(a[0]).width() < 252) && 0 !== C(t[0]).width()
        ? (C(t[0]).addClass(this.classes.narrow),
          C(s[0])
        ...
        : (C(t[0]).removeClass(this.classes.narrow),
          C(s[0])
    ...
    (B.prototype.collapse = function () {
      ...
      this.s.displayed &&
        ...
        (C(this.s.dtPane.table().container()).addClass(this.classes.hidden),
    ...
    (B.prototype.destroy = function () {
      this.s.dtPane && this.s.dtPane.off('.dtsp'),
        ...
        C(this.s.dt.table().node()).off('.dtsp'),
        this.dom.container.detach();
      for (
        var t = C.fn.dataTable.ext.search.indexOf(this.s.searchFunction);
        -1 !== t;

      )
        C.fn.dataTable.ext.search.splice(t, 1),
          (t = C.fn.dataTable.ext.search.indexOf(this.s.searchFunction));
      ...
      this.s.dtPane &&
        ...
        this.s.firstSet &&
          ...
          this.s.dt.on('stateSaveParams.dtsp', function (t, s, e) {
            if (C.isEmptyObject(e)) h.s.dtPane.state.clear();
            else {
              var a,
                i,
                n,
        ...
        this.dom.collapseButton
          ...
          .on('click.dtsp', function (t) {
            t.stopPropagation();
            t = C(h.s.dtPane.table().container());
    ...
    (B.prototype.show = function () {
      this.s.displayed &&
        ...
        C(this.s.dtPane.table().container()).removeClass(this.classes.hidden),
        this.dom.topRow.trigger('collapse.dtsps'));
    }),
    ...
    (B.prototype._updateSelection = function (t) {
      ...
      s(!0),
        setTimeout(function () {
          (e.s.scrollTop = C(e.s.dtPane.table().node()).parent()[0].scrollTop),
      ...
      if (Array.isArray(t) || t instanceof l.Api) {
        ...
        'string' == typeof this.s.colOpts.orthogonal
          ? (n[t]
            ...
            this.s.rowData.totalOptions++)
          : ((n[t] = 1), i.push({ display: s, filter: t, sort: e, type: a }));
    }),
    (B.prototype._buildPane = function (t, s, e) {
      ...
      this._displayPane(),
        this.s.listSet ||
          this.dom.dtP.on('stateLoadParams.dtsp', function (t, s, e) {
            C.isEmptyObject(i.s.dt.state.loaded()) &&
              C.each(e, function (t) {
                delete e[t];
              });
          }),
      ...
      var d,
        l = C.fn.dataTable.ext.errMode,
        e =
          ((C.fn.dataTable.ext.errMode = 'none'),
          this.dom.dtP.on('init.dt', function (t, s) {
            var e = i.dom.dtP.DataTable(),
              a = e.select.style();
            e.select.style(a);
          }),
          (r = C.fn.dataTable.versionCheck('2')
            ? ((d = C.extend(!0, {}, C.fn.dataTable.defaults.layout)),
      ...
      if (
        (this.s.customPaneSettings && this.s.customPaneSettings.header
          ? (e = this.s.customPaneSettings.header)
          : this.s.colOpts.header
            ? (e = this.s.colOpts.header)
            : this.s.colExists &&
              (e = C.fn.dataTable.versionCheck('2')
                ? this.s.dt.column(this.s.index).title()
                : this.s.dt.settings()[0].aoColumns[this.s.index].sTitle),
        (e = this._escapeHTML(e)),
        this.dom.searchBox.attr('placeholder', e),
        (C.fn.dataTable.ext.errMode = l),
        this.s.colExists)
      )
        for (var h = 0, c = this.s.rowData.arrayFilter.length; h < c; h++)
          if (this.s.dt.page.info().serverSide)
            for (
              var p = this.addRow(
                  this.s.rowData.arrayFilter[h].display,
                  this.s.rowData.arrayFilter[h].filter,
                  this.s.rowData.arrayFilter[h].sort,
                  this.s.rowData.arrayFilter[h].type
                ),
                u = 0,
                f = this.s.serverSelect;
              u < f.length;
              u++
            )
              f[u].filter === this.s.rowData.arrayFilter[h].filter &&
                ((this.s.serverSelecting = !0),
                p.select(),
                (this.s.serverSelecting = !1));
          else
            !this.s.dt.page.info().serverSide && this.s.rowData.arrayFilter[h]
              ? this.addRow(
                  this.s.rowData.arrayFilter[h].display,
                  this.s.rowData.arrayFilter[h].filter,
                  this.s.rowData.arrayFilter[h].sort,
      ...
      for (var g = 0, v = t; g < v.length; g++) {
        ...
        if (m)
          for (
            var w = 0, P = this.s.dtPane.rows().indexes().toArray();
            w < P.length;
            w++
          )
            (p = P[w]),
              this.s.dtPane.row(p).data() &&
                m.filter === this.s.dtPane.row(p).data().filter &&
                (this.s.dt.page.info().serverSide
                  ? ((this.s.serverSelecting = !0),
                    this.s.dtPane.row(p).select(),
                    (this.s.serverSelecting = !1))
                  : this.s.dtPane.row(p).select());
      }
      if (
        ...
        for (var y = 0, b = a.searchPanes.panes; y < b.length; y++) {
          var _ = b[y];
          _.id === this.s.index &&
            (_.searchTerm &&
              0 < _.searchTerm.length &&
              this.dom.searchBox.val(_.searchTerm).trigger('input'),
            _.order && this.s.dtPane.order(_.order).draw(),
            _.collapsed ? this.collapse() : this.show());
        }
      }
      return !0;
    }),
    ...
    (B.prototype._getBonusOptions = function () {
      return C.extend(!0, {}, B.defaults, { threshold: null }, this.c || {});
    }),
    ...
    (B.prototype._searchExtras = function () {
      var t = this.s.updating,
        ...
        a = C(this.s.dtPane.table().container());
      -1 < e && (s[e] = ''),
        0 < s.length
