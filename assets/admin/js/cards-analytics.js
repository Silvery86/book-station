...
!(function () {
  ...
  (c = document.querySelector('#carrierPerformance')),
    (r = {
      chart: {
        height: 330,
        type: 'bar',
      ...
      legend: {
        show: !0,
        position: 'bottom',
        markers: { width: 8, height: 8, offsetX: -5, radius: 12 },
        height: 40,
        offsetY: 0,
        itemMargin: { horizontal: 10, vertical: 0 },
        fontSize: '13px',
    ...
    null !== c && new ApexCharts(c, r).render(),
    (a = document.querySelector('#deliveryExceptionsChart')),
    (c = {
