    ...
    ((t = n.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (t, e, s, a) {
            var n = s.product_name,
              ...
              c = s.image;
            return (
              '<div class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper"><div class="avatar avatar me-4 rounded-2 bg-label-secondary">' +
              (c
                ? '<img src="' +
                  assetsPath +
                ...
                : '<span class="avatar-initial rounded-2 bg-label-' +
                  ...
                  '</span>') +
              '</div></div><div class="d-flex flex-column"><h6 class="text-nowrap mb-0">' +
              n +
              '</h6><small class="text-truncate d-none d-sm-block">' +
              o +
              '</small></div></div>'
            );
          },
        ...
        },
        {
          ...
          orderable: !1,
          render: function (t, e, s, a) {
            return '<div class="d-inline-block text-nowrap"><button class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light"><i class="ti ti-edit ti-md"></i></button><button class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical ti-md"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:0;" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item">Suspend</a></div></div>';
          },
        },
      ],
      order: [2, 'asc'],
