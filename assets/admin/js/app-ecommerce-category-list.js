            ...
            },
            {
              ...
              render: function (e, t, a, s) {
                var o = a.categories,
                  ...
                  i = a.id;
                return (
                  '<div class="d-flex align-items-center"><div class="avatar-wrapper me-3 rounded-2 bg-label-secondary"><div class="avatar">' +
                  (n
                    ? '<img src="' +
                      assetsPath +
                    ...
                    : '<span class="avatar-initial rounded-2 bg-label-' +
                      ...
                      (n = (
                        ((n =
                          (o = a.category_detail).match(/\b\w/g) ||
                          []).shift() || '') + (n.pop() || '')
                      ).toUpperCase()) +
                      '</span>') +
                  '</div></div><div class="d-flex flex-column justify-content-center"><span class="text-heading text-wrap fw-medium">' +
                  o +
                  '</span><span class="text-truncate mb-0 d-none d-sm-block"><small>' +
                  r +
                  '</small></span></div></div>'
                );
              },
