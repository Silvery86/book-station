  ...
  a.length &&
    a.DataTable({
      ...
      initComplete: function (e, t) {
        a.find('tbody tr:first').addClass('border-top-0'),
    ...
    t.length &&
              ...
              return (
                ...
                (l
                  ...
                  : '<span class="avatar-initial rounded-circle bg-label-' +
                    ...
                    '">' +
                    (l = (
                      ((l = (i = a.full_name).match(/\b\w/g) || []).shift() ||
                        '') + (l.pop() || '')
                    ).toUpperCase()) +
                    '</span>') +
      ...
      window.Helpers.isNavbarFixed()
        ? ((e = $('#layout-navbar').outerHeight()),
          new $.fn.dataTable.FixedHeader(t).headerOffset(e))
      ...
      s.DataTable({
        ...
        columnDefs: [
          ...
          },
          {
            ...
            orderable: !1,
            render: function (e, t, a, s) {
              return '<div class="d-inline-block"><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical ti-md"></i></a><div class="dropdown-menu dropdown-menu-end m-0"><a href="javascript:;" class="dropdown-item">Details</a><a href="javascript:;" class="dropdown-item">Archive</a><div class="dropdown-divider"></div><a href="javascript:;" class="dropdown-item text-danger delete-record"></i>Delete</a></div></div><a href="javascript:;" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ti ti-pencil ti-md"></i></a>';
            },
          },
        ],
