...
!(function () {
  ...
  const o = document.querySelector('#horizontalBarChart'),
    i = {
      ...
      xaxis: {
        ...
        axisTicks: { show: !1 },
        labels: {
          style: { colors: e, fontSize: '13px', fontFamily: 'Public Sans' },
          formatter: function (e) {
            return e + '%';
          },
        },
      ...
      tooltip: {
        ...
        custom: function ({ series: e, seriesIndex: t, dataPointIndex: a }) {
          return '<div class="px-3 py-2"><span>' + e[t][a] + '%</span></div>';
        },
      },
      legend: { show: !1 },
    };
  ...
  var n,
        ...
        s.forEach(function (e) {
          var t = config.colors[e.dataset.color],
            ...
            t =
              ...
              {
                chart: {
                  height: 'true' == (s = s) ? 58 : 48,
                  width: 'true' == s ? 58 : 38,
                  type: 'radialBar',
                },
                plotOptions: {
                  radialBar: {
                    hollow: { size: 'true' == s ? '50%' : '25%' },
                    dataLabels: {
                      show: 'true' == s,
                      value: {
                        offsetY: -10,
    ...
    l = {
      angular:
        '<span class="badge bg-label-danger rounded p-1_5"><i class="ti ti-brand-angular ti-28px"></i></span>',
      figma:
        '<span class="badge bg-label-warning rounded p-1_5"><i class="ti ti-brand-figma ti-28px"></i></span>',
      react:
        '<span class="badge bg-label-info rounded p-1_5"><i class="ti ti-brand-react-native ti-28px"></i></span>',
      art: '<span class="badge bg-label-success rounded p-1_5"><i class="ti ti-color-swatch ti-28px"></i></span>',
      fundamentals:
        '<span class="badge bg-label-primary rounded p-1_5"><i class="ti ti-diamond ti-28px"></i></span>',
    };
  a.length &&
    ((n = a.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (e, t, a, s) {
            var r = a.status;
            return (
              '<div class="d-flex align-items-center gap-3"><p class="fw-medium mb-0 text-heading">' +
              r +
        ...
        },
        {
          ...
          render: function (e, t, a, s) {
            return (
              '<div class="d-flex align-items-center justify-content-between"><div class="w-px-50 d-flex align-items-center"><i class="ti ti-users ti-lg me-2 text-primary"></i><span>' +
              a.user_number +
              '</span></div><div class="w-px-50 d-flex align-items-center"><i class="ti ti-book ti-lg me-2 text-info"></i><span>' +
              a.note +
              '</span></div><div class="w-px-50 d-flex align-items-center"><i class="ti ti-video ti-lg me-2 text-danger"></i><span>' +
              a.view +
              '</span></div></div>'
            );
          },
