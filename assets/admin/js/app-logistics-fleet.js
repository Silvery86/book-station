!(function () {
  ...
  for (const i of t.features) {
    ...
    (o.className = 'marker'),
      ...
      new mapboxgl.Marker(o).setLngLat(i.geometry.coordinates).addTo(r);
  ...
  e = document.getElementById('carFleet-1');
  Helpers._addClass('marker-focus', e),
    document
