...
!(function () {
  ...
  e &&
    ...
    o && o.flatpickr({ monthSelectorType: 'static' }),
    a && a.flatpickr({ monthSelectorType: 'static' });
})(),
  $(function () {
    var n,
      o,
    ...
    $(document).on('click', '.tax-select', function (e) {
      ...
      e.length &&
        $(document).on('click', '.btn-apply-changes', function (e) {
          ...
          (l = t.closest('.dropdown-menu').find('#taxInput1')),
            (c = t.closest('.dropdown-menu').find('#taxInput2')),
      ...
      $(document).on('change', '.item-details', function () {
        ...
        e.next('textarea').length
          ...
          : e.after(
              '<textarea class="form-control" rows="2">' + t + '</textarea>'
            );
      });
  });
