    ...
    setTimeout(() => {
      ...
      t &&
        t.addEventListener('click', function () {
          (offCanvasEl = new bootstrap.Offcanvas(e)),
            (e.querySelector('.dt-full-name').value = ''),
            (e.querySelector('.dt-post').value = ''),
            (e.querySelector('.dt-email').value = ''),
            (e.querySelector('.dt-date').value = ''),
            (e.querySelector('.dt-salary').value = ''),
            offCanvasEl.show();
        });
    }, 200),
                  ...
                  return (
                    ...
                    (n
                      ...
                      : '<span class="avatar-initial rounded-circle bg-label-' +
                        ...
                        (n = (
                          ((n =
                            (i = a.full_name).match(/\b\w/g) || []).shift() ||
                            '') + (n.pop() || '')
                        ).toUpperCase()) +
                        '</span>') +
              ...
              .each(function (t, e) {
                s !== t &&
                  ($(a)
                    .eq(e)
                    .before(
                      '<tr class="group"><td colspan="8">' + t + '</td></tr>'
                    ),
                  (s = t));
              });
          },
